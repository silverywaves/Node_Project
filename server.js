...
let db
const url = 'mongodb+srv://admin:qwer1234@cluster0.d9vvbdp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
app.get('/shop', function(요청, 응답){      // 콜백함수(다른 함수 파라미터에 들어가는 함수)-사용불가인 곳도 있음
...
app.get('/list', async(요청, 응답)=>{           // await 쓰려면 async 를 콜백함수 왼쪽에 붙여야 함
